                        ...
                        <div class="js_wrap claerdix" style="background-color: whitesmoke;">
                            <div class="js_con clearfix">
                                ...
                                <div class="js_r">
                                    <p>&nbsp;</p>
                                    <c:choose>
                                        <c:when test="${scenic.price==0}">
                                            <p style="color: #1a7dbc;font-size: 18px">
                                                门票免费
                                            </p>
                                    ...
                                    <c:choose>
                                        <c:when test="${scenic.price==0}">
                                            <a href="#" class="btn btn-default btn-info" data-toggle="modal"
                                               data-target="#shouldKnowDialog">预约须知</a>
                                        </c:when>
                                        <c:otherwise>
                                            <a href="#" class="btn btn-default btn-info" data-toggle="modal"
                                               data-target="#shouldKnowDialog">购买须知</a>
                                        </c:otherwise>
                                    </c:choose>
                                </div>
                            </div>
                                ...
                                <div class="js_con clearfix">
                                    ...
                                    <div class="js_r" style="padding-right: 11px; ">
                                        <c:choose>
                                            <c:when test="${ticket.cprice==0}">
                                                <p>
                                                <form action="${pageContext.request.contextPath }/getOrderInfo1?id=${ticket.id}"
                                                      method=post>
                                                    <input type="submit" value="预约" class="btn btn-default btn-info"
                                                           style="padding: 3px 6px;font-size: 11px"onclick="alert('预约成功，请到订单页面进行查看！')">
                                                </form>
                                                </p>
                                            </c:when>
                                            <c:otherwise>
                                                <p>
                                                <form action="${pageContext.request.contextPath }/getOrderInfo?id=${ticket.id}"
                                                      method=post>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">预约须知</h4>
            </div>
            <form action="${pageContext.request.contextPath }/insertManager" class="form-horizontal" id="add_form"
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <label for="add_name" class="col-sm-10 control-label"
                                   style="text-align: left">不指定日期，仅可使用一次</label>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <label for="add_name" class="col-sm-10 control-label"
                                   style="text-align: left">预订后不可以退票</label>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <label for="add_name" class="col-sm-10 control-label"
                                   style="text-align: left">以景区优惠信息为准</label>
                        </div>
                    </div>
                    <div class="form-group">
